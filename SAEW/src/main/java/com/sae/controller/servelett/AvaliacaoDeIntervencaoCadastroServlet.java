...
/**
 * Servlet implementation class AvaliacaoDeIntervencaoCadastroServlet
 */
public class AvaliacaoDeIntervencaoCadastroServlet extends HttpServlet {
	 ...
	 */
	public AvaliacaoDeIntervencaoCadastroServlet() {
		super();
	...
	public void tratamentoDoPossivelErro(boolean rsp, HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		if (rsp) {
			response.sendRedirect("jsp/intervecoeslia.jsp");
		} else {
